...
module.exports = function(options) {
  ...
  return function(tagName, attribs) {
    ...
    if (isOpenGraphUrl(tagName, attribs)) {
      attribs.content = updateHrefAttribute(attribs.content);
    }
  ...
  function isOpenGraphUrl(tagName, attribs) {
    if (tagName !== 'meta') return false;
    if (attribs.property === 'og:url' || attribs.property === 'og:image') return true;
    return false;
  }
