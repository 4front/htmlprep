...
module.exports = Parser = function(options, output) {
  ...
  this._customAttrs = {};
  _.each(['build', 'placeholder', 'content-variation', 'src-expand', 'href-expand'], function(name) {
...
Parser.prototype.onOpenTag = function(tagName, attribs) {
  ...
  if (tagName === 'script' && attribs[this._customAttrs['src-expand']]) {
    ...
    var globPattern = attribs[this._customAttrs['src-expand']];
  ...
  if (tagName === 'link' && attribs[this._customAttrs['href-expand']]) {
    var globPattern = attribs[this._customAttrs['href-expand']];
